...
const TimeLine = () => {
  ...
  return (
    <div className='px-5 lg:pt-28 md:py-20 sm:py-14 py-8 lg:pb-40 overflow-y-clip'>
      <div className="max-w-[1400px] mx-auto">
        <div className="relative">
          {
            timeLineData.map((item, index) => (
              <div ref={(el) => { boxRef.current[index] = el }} key={index} className=" sticky! top-14">
                <div className={`w-full flex relative lg:pl-0 sm:pl-15 pl-12 ${index % 2 !== 0 ? "lg:justify-start" : "lg:justify-end"} ${index === 0 ? "mt-0" : "lg:-mt-12"}`}>
