...
const Footer = () => {
  return (
    <div className='px-5 md:py-16 sm:py-14 py-8'>
      <div className="max-w-[1600px] mx-auto w-full justify-around">
        <div className="flex justify-around flex-row flex-wrap w-full gap-10">
